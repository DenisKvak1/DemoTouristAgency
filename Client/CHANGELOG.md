...
- Create Angular project with ng: `ng new clientdemoangular.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`clientdemoangular.client.esproj`).
